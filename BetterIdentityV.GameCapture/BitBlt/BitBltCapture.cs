...
namespace BetterIdentityV.GameCapture.BitBlt;
...
public class BitBltCapture : IGameCapture
{
    ...
    private void CheckSession()
    {
        ...
        {
            Console.Error.WriteLine("[BitBlt]Failed to create session:{0}", e);
        }
        finally
        {
            _lockSlim.ExitWriteLock();
    ...
    private Mat? Capture0()
    {
        ...
        catch (Exception e)
        {
            ...
            Console.Error.WriteLine("[BitBlt]Failed to capture image {0}", e);
            return null;
        }
    }
