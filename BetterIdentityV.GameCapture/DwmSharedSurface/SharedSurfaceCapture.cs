using BetterIdentityV.GameCapture.Graphics.Helpers;
...
namespace BetterIdentityV.GameCapture.DwmSharedSurface;
...
public partial class SharedSurfaceCapture : IGameCapture
{
    ...
    private static ResourceRegion? GetGameScreenRegion(nint hWnd, nint captureAreaHandle)
    {
        ...
        {
            User32.GetWindowRect(hWnd, out var sourceWindowWithShadowRect);
            return CaptureSettings.CreateRelativeRegionFromScreenOrigin(captureAreaHandle, sourceWindowWithShadowRect.Left, sourceWindowWithShadowRect.Top);
        }
